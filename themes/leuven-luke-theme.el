...
(defgroup leuven-luke nil
  "Leuven-Luke theme options.
The theme has to be reloaded after changing anything in this group."
  :group 'faces)

(defcustom leuven-luke-scale-outline-headlines t
...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol1 `(,@(when leuven-luke-scale-outline-headlines (list :height 1.3)) :weight bold :overline "#A7A7A7" :foreground "#3C3C3C" :background "#F0F0F0"))
  ...
  (custom-theme-set-faces
   ...
   `(default ((,class (:foreground "#4C2F2D" :background "#E5E1CE"))))
   ;;`(bold ((,class (:weight bold :foreground "black"))))
   `(bold ((,class (:weight bold :foreground "#A13B20"))))
   ;;`(bold-italic ((,class (:weight bold :slant italic :foreground "black"))))
   `(bold-italic ((,class (:weight bold :slant italic :foreground "#A13B20"))))
   ...
   `(leuven-luke-org-deadline-overdue ((,class (:foreground "#F22659"))))
   `(leuven-luke-org-deadline-today ((,class (:weight bold :foreground "#4F4A3D" :background "#FFFFCC"))))
   `(leuven-luke-org-deadline-tomorrow ((,class (:foreground "#40A80B"))))
   `(leuven-luke-org-deadline-future ((,class (:foreground "#40A80B"))))
   `(leuven-luke-gnus-unseen ((,class (:weight bold :foreground "#FC7202"))))
   `(leuven-luke-gnus-date ((,class (:foreground "#FF80BF"))))
   `(leuven-luke-gnus-size ((,class (:foreground "#8FBF60"))))
   `(leuven-luke-todo-items-face ((,class (:weight bold :foreground "#FF3125" :background "#FFFF88"))))
...
(custom-theme-set-variables 'leuven-luke
...
(when (string-match "/etc/themes/$"
  ...
  (message "To stay up-to-date, you should better install and use leuven-luke-theme from MELPA.")
  (sit-for 2))

(provide-theme 'leuven-luke)
...
;;; leuven-luke-theme.el ends here
